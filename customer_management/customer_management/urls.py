...
urlpatterns = [
    ...
    path('api/', include('customers.urls')),  # Includes customer-related URLs
    path('auth/', include('djoser.urls')),  # Includes Djoser URLs
    path('auth/', include('djoser.urls.jwt')),  # Includes JWT authentication URLs
