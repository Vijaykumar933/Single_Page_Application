...
SECRET_KEY = 'django-insecure--k*&=(cam!6z=*tnsbqzyg#-@!$(rpi11m(oo*uhguxvar((o&'
...
INSTALLED_APPS = [
    ...
    'rest_framework',
    'rest_framework_simplejwt',  # JWT for auth
...
REST_FRAMEWORK = {
    ...
    'DEFAULT_PERMISSION_CLASSES': (
        'rest_framework.permissions.IsAuthenticated',  # Ensure default permissions require authentication
    ),
}
